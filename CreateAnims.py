...
CREATEANIMS_VERSION = "v1.0.2" #The third one means pre-release. Not meant to be used in production but maybe you want it to test some stuff and things like that. Mostly meant for before v1.0.
